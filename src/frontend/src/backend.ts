...
import type { Order as _Order, OrderItem as _OrderItem, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async placeOrder(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: Array<OrderItem>, arg6: bigint, arg7: bigint, arg8: bigint, arg9: string, arg10: string): Promise<bigint> {
        if (this.processError) {
            try {
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        city: value.city,
        createdBy: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.createdBy)),
        email: value.email,
